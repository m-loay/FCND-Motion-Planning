...
'''
Below you'll form a sequence of rotations. The rotation matrix R is the mapping of performing 
the rotations in sequential order. Multiplying a vector by R will perform the rotations on that vector.
'''
...
Now calculate three different rotations matrices. They should stem from the same set of Euler rotations, 
just in differing order
'''
